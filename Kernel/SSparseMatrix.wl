...
BeginPackage["AntonAntonov`SSparseMatrix`"];
...
(*------------------------------------------------------------*)
(* Abs & Clip & N & Rescale & Total & Unitize                 *)
(*------------------------------------------------------------*)
...
ImposeRowNames[rmat_SSparseMatrix, rowNames : Association[(_String -> _Integer) ..]] :=
    Block[{arules, rmatRowNames, aInds, resMat},
      ...
      Block[{mrls = Most[arules]},
        arules =
            Append[
              Thread @ Rule[ Thread @ { Lookup[ aInds, mrls[[All, 1, 1]] ], mrls[[All, 1, 2]] }, mrls[[All, 2]] ],
              Last[arules]
            ];
      ];
